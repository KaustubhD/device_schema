...
BEGIN
    ...
    SELECT address_id INTO adrss_id FROM address WHERE address.address_type_id=add_type_id and address.address=addres and address.city_id=city_id and address.PIN=pin;
    if(adrss_id is null)
    then
