...
INSERT INTO `address` VALUES (1,'faridabad','haryana','india'),(2,'panipat','haryana','india'),(3,'gurgaon','haryana','india');
...
CREATE TABLE `user` (
  ...
  KEY `user_to_address_idx` (`address_id`),
  KEY `user_to_designation_idx` (`designation_id`),
  CONSTRAINT `user_to_address` FOREIGN KEY (`address_id`) REFERENCES `address` (`address_id`),
...
INSERT INTO `user` VALUES (1,'megha',NULL,'gupta','mgupta@ex2india.com',1,'+916847524983','123',2,132103,'1997-10-02','2020-01-15','iammeghnath@haha',_binary ''),(2,'suraj','singh','rawat','ssrawat@ex2india.com',1,'+914785487584','420-G',1,121010,'1997-05-12','2020-01-15','menusabpatasi',_binary ''),(3,'rishabh',NULL,'bisht','rbisht@ex2india.com',1,'+916847879983','921',1,121001,'1997-01-01','2020-01-15','fattu',_binary ''),(4,'jaswinder','singh','chawla','jschawla@ex2india.com',1,'+914785123584','111-13',1,121006,'1998-05-24','2020-01-15','merekonikaldenge',_binary '\0');
...
-- Dump completed on 2020-02-28 12:25:13
